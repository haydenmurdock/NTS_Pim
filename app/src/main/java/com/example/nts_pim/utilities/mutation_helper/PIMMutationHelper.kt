...
//    }
    ...
    fun updatePimSettings(blueToothAddress: String?, appVersion: String?, appSyncClient: AWSAppSyncClient, deviceId: String){
        val updatePimSettings = UpdatePIMSettingsInput
            ...
            .build()
        appSyncClient.mutate(UpdatePimSettingsMutation.builder().parameters(updatePimSettings).build())
        LoggerHelper.writeToLog("Pim Mutation Helper: update pim settings: blueToothAddress: $blueToothAddress: AppVersion: $appVersion: deviceId:$deviceId to aws")
    }
